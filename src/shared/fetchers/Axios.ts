...
export const UsersManagementFetcher = axios.create({
  baseURL: "https://50.116.39.140:8080/v1/users-management",
  timeout: 40000,
...
export const SchemaDiscover = axios.create({
  baseURL: "https://50.116.39.140:8080/v1/schema-discover",
  timeout: 40000,
  // headers: {'X-Custom-Header': 'foobar'}
});

export const ProjectManager = axios.create({
  baseURL: "https://50.116.39.140:8080/v1/project-manager",
  timeout: 40000,
  // headers: {'X-Custom-Header': 'foobar'}
});

export const DataLoader = axios.create({
  baseURL: "https://50.116.39.140:8080/v1",
  timeout: 40000,
  // headers: {'X-Custom-Header': 'foobar'}
});
