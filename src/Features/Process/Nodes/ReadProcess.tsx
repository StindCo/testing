...
export default function ReadProcessNode({ id, type, data, isConnectable }: any) {
  ...
  return (
    <div className="flex flex-col justify-center items-center space-y-2">
      <div
        ...
        } animatecss relative text-sm p-2 bg-cyan-600 w-10 h-10 items-center flex justify-center rounded-full text-white`}
      >
      ...
      <div className="text-[7px] text-center">
        {config?.tableSelected?.name || "Import process"}
        <br />
