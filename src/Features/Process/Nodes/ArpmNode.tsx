...
export default function ArpmNode({ id, type, data, isConnectable }: any) {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="text-[9px] mb-1 text-center font-[PoppinsBold]">
        {config?.tableSelected?.name || "A.R.P.M"}
      ...
      >
        ...
        <div
          ...
          className="absolute rounded no-drag cursor-pointer hover:bg-pink-700 w-6 h-4 items-center justify-center flex bottom-[-11px] right-[18px] z-1 bg-cyan-600 text-slate-800  text-xs"
        >
