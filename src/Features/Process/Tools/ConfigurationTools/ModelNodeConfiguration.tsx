...
export default function ModelNodeConfiguration({ details }: any) {
  ...
  const getDatas = async () => {
    ...
    try {
      ...
      if (operateurSelected == null) {
        response = await loadData(tableSelected);
      } else {
              ...
              <div className="w-full bg-[#fafafa] h-full overflow-hidden overflow-y-scroll no-scrollBar">
                {step == 1 && (
                  ...
                  >
                    ...
                    />
                    <div className="grid grid-cols-3 gap-8 select-none p-8">
