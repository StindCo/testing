    ...
    try {
      ...
      data = data.map((item: any) => {
        Object.keys(item).forEach((key) => {
          if (key.includes("total") || key.includes("arpu") || key.includes("month"))
    ...
    <div>
      <header className="border-b p-3 px-4 w-full flex flex-row items-center justify-between">
        <h3 className="text-xl flex flex-row items-center space-x-4">
          {" "}
          <BsGear size={30} /> <span>Préparation du calcul du M.O.U</span>{" "}
        </h3>
                    ...
                    <div className="grid grid-cols-3 gap-10 select-none px-20 pt-8 w-full mt-8">
                      ...
                      >
                        <div className="clear-both cursor-pointer overflow-hidden text-ellipsis flex flex-col items-center space-y-4 py-8 px-4">
                          ...
                          <p className="text-ellipsis text-sm">MOU on-net</p>
                        </div>
                      </div>
                      <div
                        onClick={(e) => {
                          setMouType("off-net-national");
                          setTimeout(() => setStep(2), 1000);
                        }}
                        className={`border rounded-lg ${
                          mouType == "off-net-national"
                            ? "bg-[#fff] border-[#0099cc]"
                            : "bg-[#fcfcfc]"
                        }  text-slate-800 border-[#e5e9f0]`}
                      >
                        <div className="clear-both cursor-pointer overflow-hidden text-ellipsis flex flex-col items-center space-y-4 py-8 px-4">
                          <MdSettingsVoice className="text-7xl text-slate-800" />
                          <p className="text-ellipsis text-sm">MOU off-net national</p>
                        </div>
                      </div>
                      <div
                        onClick={(e) => {
                          setMouType("in-net-national");
                          setTimeout(() => setStep(2), 1000);
                        }}
                        className={`border rounded-lg ${
                          mouType == "in-net-national"
                            ? "bg-[#fff] border-[#0099cc]"
                            : "bg-[#fcfcfc]"
                        }  text-slate-800 border-[#e5e9f0]`}
                      >
                        <div className="clear-both cursor-pointer overflow-hidden text-ellipsis flex flex-col items-center space-y-4 py-8 px-4">
                          <MdSettingsVoice className="text-7xl text-slate-800" />
                          <p className="text-ellipsis text-sm">MOU in-net national</p>
                        </div>
                      </div>
                      <div
                        onClick={(e) => {
                          setMouType("off-net-international");
                          setTimeout(() => setStep(2), 1000);
                        }}
                        className={`border rounded-lg ${
                          mouType == "off-net-international"
                            ? "bg-[#fff] border-[#0099cc]"
                            : "bg-[#fcfcfc]"
                        }  text-slate-800 border-[#e5e9f0]`}
                      >
                        <div className="clear-both cursor-pointer overflow-hidden text-ellipsis flex flex-col items-center space-y-4 py-8 px-4">
                          <MdSettingsVoice className="text-7xl text-slate-800" />
                          <p className="text-ellipsis text-sm">MOU off-net international</p>
                        </div>
                      </div>
                      <div
                        onClick={(e) => {
                          setMouType("in-net-international");
                          setTimeout(() => setStep(2), 1000);
                        }}
                        className={`border rounded-lg ${
                          mouType == "in-net-international"
                            ? "bg-[#fff] border-[#0099cc]"
                            : "bg-[#fcfcfc]"
                        }  text-slate-800 border-[#e5e9f0]`}
                      >
                        <div className="clear-both cursor-pointer overflow-hidden text-ellipsis flex flex-col items-center space-y-4 py-8 px-4">
                          <MdSettingsVoice className="text-7xl text-slate-800" />
                          <p className="text-ellipsis text-sm">MOU in-net international</p>
                        </div>
                      </div>
                      <div
                        onClick={(e) => {
                          setMouType("roaming-sortant");
                          setTimeout(() => setStep(2), 1000);
                        }}
                        className={`border rounded-lg ${
                          mouType == "roaming-sortant"
                            ? "bg-[#fff] border-[#0099cc]"
                            : "bg-[#fcfcfc]"
                        }  text-slate-800 border-[#e5e9f0]`}
                      >
                        <div className="clear-both cursor-pointer overflow-hidden text-ellipsis flex flex-col items-center space-y-4 py-8 px-4">
                          <MdSettingsVoice className="text-7xl text-slate-800" />
                          <p className="text-ellipsis text-sm">MOU roaming sortant</p>
                        </div>
                      </div>
                      <div
                        onClick={(e) => {
                          setMouType("roaming-entrant");
                          setTimeout(() => setStep(2), 1000);
                        }}
                        className={`border rounded-lg ${
                          mouType == "roaming-entrant"
                            ? "bg-[#fff] border-[#0099cc]"
                            : "bg-[#fcfcfc]"
                        }  text-slate-800 border-[#e5e9f0]`}
                      >
                        <div className="clear-both cursor-pointer overflow-hidden text-ellipsis flex flex-col items-center space-y-4 py-8 px-4">
                          <MdSettingsVoice className="text-7xl text-slate-800" />
                          <p className="text-ellipsis text-sm">MOU roaming entrant</p>
                        </div>
                      </div>
                      ...
                      >
                        <div className="clear-both cursor-pointer overflow-hidden text-ellipsis flex flex-col items-center space-y-4 py-8 px-4">
                          <MdSettingsVoice className="text-7xl text-slate-800" />
                          <p className="text-ellipsis text-sm">MOU Global</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="justify-center items-center flex-col flex ">
                    ...
                    <div className="grid grid-cols-4 gap-10 select-none px-20 pt-8 w-full mt-8">
                      ...
                      >
                        <div className="clear-both cursor-pointer overflow-hidden text-ellipsis flex flex-col items-center space-y-4 py-8 px-4">
                          <MdOutlineSettingsPhone className="text-7xl text-slate-800" />
                          <p className="text-ellipsis text-sm">Tout réseau</p>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="clear-both cursor-pointer overflow-hidden text-ellipsis flex flex-col items-center space-y-4 py-8 px-4">
                          <p className="text-ellipsis text-lg font-[PoppinsBold]">
                            ...
                            <>
                              ...
                              <p className="text-ellipsis text-sm">MoU {mouType}</p>
                            </>
